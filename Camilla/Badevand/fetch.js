...
function populateDOM(item) {
  ...
  lakeUpdate.textContent = `Sidst opdateret ${item.lastUpdatedInHoursAgo}timer og ${item.lastUpdatedInMinutesAgo}minutter siden`;
