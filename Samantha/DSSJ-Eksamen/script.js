    ...
    fetch('quizCastleSon.json')
      ...
      .then(quizData => {
        ...
        quizData.forEach(question => {
          ...
          subtitleSection.appendChild(subtitleElement); // Untertitel hinzufügen
            ...
            options.forEach(option => {
              ...
              if (button === selectedButton) {
                if (option.isCorrect) {
                  ...
                  // Finde und hervorhebe die richtige Antwort
